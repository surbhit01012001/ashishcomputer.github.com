...
<!-- Example of additional sections for these links -->
    ...
    <div class="course-card">
		      <div class="course-header">DCP</div>
		      <h2>Diploma in Computer Programming</h2>
    ...
    <div class="course-card">
      <div class="course-header">DAA</div>
		      <h2>Diploma in Advance Accounting</h2>
		      <p><strong>Duration:</strong> 6 months</p>
		      <ul>
		        <li>We Assure To Provide You With The Best In Our Institute.</li>
		      </ul>
		      <button>Read more</button>
    </div>
    <div class="course-card">
